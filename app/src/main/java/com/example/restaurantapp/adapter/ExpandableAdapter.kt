...
class ExpandableAdapter (private var c: Context, private val foodList:List<FoodData>) : RecyclerView.Adapter<ExpandableAdapter.FruitsViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FruitsViewHolder {
            ...
            val v = DataBindingUtil.inflate<ItemlistlayoutBinding>(infalter,
                R.layout.itemlistlayout,parent,false)
...
/*
class ExpandableAdapter (val context: Context, val list:ArrayList<FoodData>) :RecyclerView.Adapter<ExpandableAdapter.ViewHolderclss>() {

...
import com.example.restaurantapp.databinding.ItemsBinding
import com.example.restaurantapp.ui.HomeFragment
import com.example.restaurantapp.ui.NewActivity

class FoodsAdapter(private var c: Context, private val foodList:List<FoodData>): RecyclerView.Adapter<FoodsAdapter.FruitsViewHolder>()
{

    inner class FruitsViewHolder(val v: ItemsBinding):RecyclerView.ViewHolder(v.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FruitsViewHolder {
        val infalter = LayoutInflater.from(parent.context)
        val v = DataBindingUtil.inflate<ItemsBinding>(infalter,
